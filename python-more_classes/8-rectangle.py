...
the number of instances created and deleted, and allows changing the
print symbol used for the rectangle's string representation. The class
also includes a static method to compare rectangles based on their area.
"""
