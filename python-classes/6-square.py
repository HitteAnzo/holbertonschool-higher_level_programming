...
and methods for initialization, retrieving and setting these attributes.
C alculating the area,
...
class Square:
    ...
    Allows setting and getting
    size and position, calculates the area.
    ...
    def my_print(self):
        ...
        The position is indicated by spaces and
        new lines based on position[0] and position[1].
